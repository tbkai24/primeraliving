...
<div class="container-fluid py-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <button id="toggleArchived" class="btn btn-outline-secondary btn-sm">
      <i class="fas fa-archive me-1"></i> Show Archived <span id="archivedCount" class="badge bg-secondary ms-1">0</span>
    </button>
  </div>
...
<script src="../asset/js/transactions.js?v=<?= time() ?>"></script>
